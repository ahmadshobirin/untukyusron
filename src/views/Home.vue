<template>
  <div class="container my-3 mx-auto px-2">
    ...
    <div class="max-w-sm my-5 rounded overflow-hidden shadow-lg">
      <img class="w-full" src="https://steamuserimages-a.akamaihd.net/ugc/993513763556387678/B25AA8BE2313A5D1791FB2ADC190B6A61F6EC9BB/?imw=512&imh=512&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=true" alt="Sunset in the mountains">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Nero [DMC 5]</div>
